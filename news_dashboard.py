...
# --- 키워드 프리셋 ---
preset_hotel = "호텔 리모델링, 신규 호텔 오픈, 리조트 착공, 5성급 호텔 리뉴얼, 호텔 FF&E, 생활숙박시설 분양, 호텔 매각, 해외 리조트"
preset_office = "사옥 이전, 통합 사옥 건립, 스마트 오피스, 기업 연수원 건립, 공공청사 리모델링, 공유 오피스 출점, 오피스 인테리어"
preset_market = "건자재 가격, 친환경 자재, 모듈러 주택, 아파트 특판 가구, 한샘 B2B, LX하우시스, 현대건설 수주, DL건설 수주, 디엘이앤씨 수주"
