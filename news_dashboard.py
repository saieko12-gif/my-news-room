...
if mode == "📰 뉴스 모니터링":
    ...
    # [핵심 수정] 여기에 미분양, 건축허가, 매매거래, 입주물량 다 때려 넣음!
    preset_trend = (
        "대구 미분양 주택, 경북 미분양 현황, 대구 아파트 입주 물량, "
        "대구 주택 준공 실적, 대구 건축허가 면적, 아파트 매매 거래량, "
        "건설산업연구원 전망, 대한건설협회 수주, 건설 수주액"
    )
